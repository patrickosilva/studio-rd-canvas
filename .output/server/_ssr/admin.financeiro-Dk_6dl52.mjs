...
import { a as adminListarPagamentosAssinatura } from "./assinatura.functions-CyMYEz97.mjs";
import "../_libs/seroval.mjs";
import { D as DollarSign, i as Scissors, f as Crown, B as TrendingUp, R as Receipt, w as CircleX, N as Printer, O as Download, F as FileChartColumnIncreasing, g as ChartColumn, o as CircleCheck, p as Clock, l as CalendarClock, W as Wallet, r as CreditCard } from "../_libs/lucide-react.mjs";
...
function FinanceiroPage() {
  ...
  const [pagamentosAssinatura, setPagamentosAssinatura] = reactExports.useState([]);
  const [periodo, setPeriodo] = reactExports.useState("semanaAtual");
  ...
  const intervaloPeriodo = reactExports.useMemo(() => obterIntervaloPeriodo(periodo), [periodo]);
  const agendamentosNoPeriodo = reactExports.useMemo(() => {
  ...
  const agendamentosRecebidosNoPeriodo = reactExports.useMemo(() => {
  ...
  const pagamentosAssinaturaFiltrados = reactExports.useMemo(() => {
  ...
  const faturamentoPorPagamento = reactExports.useMemo(() => {
  ...
  const resumoPorDia = reactExports.useMemo(() => {
  ...
  const movimentosFinanceiros = reactExports.useMemo(() => {
  ...
  const ultimosMovimentos = reactExports.useMemo(() => movimentosFinanceiros.slice(0, 10), [movimentosFinanceiros]);
  const filtros = [{
    label: "Hoje",
    value: "hoje"
  }, {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl p-8 lg:p-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "Financeiro", subtitle: `Caixa do período: ${formatarIntervalo(intervaloPeriodo.inicio, intervaloPeriodo.fim)}. Para histórico completo, use a aba Relatórios.`, actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleExportarPdf, disabled: movimentosFinanceiros.length === 0, className: "inline-flex h-10 items-center rounded-full border border-gold bg-gold-soft px-5 text-sm text-gold transition hover:bg-gold-soft/80 disabled:cursor-not-allowed disabled:opacity-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "mr-2 h-4 w-4" }),
        "Imprimir / PDF"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: handleExportarCsv, disabled: movimentosFinanceiros.length === 0, className: "inline-flex h-10 items-center rounded-full border border-border px-5 text-sm transition hover:bg-surface-elevated disabled:cursor-not-allowed disabled:opacity-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "mr-2 h-4 w-4" }),
        "CSV"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/admin/relatorios", className: "inline-flex h-10 items-center rounded-full border border-border px-5 text-sm transition hover:bg-surface-elevated", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileChartColumnIncreasing, { className: "mr-2 h-4 w-4" }),
        "Ver relatório completo"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/admin/agenda", className: "inline-flex h-10 items-center rounded-full border border-border px-5 text-sm transition hover:bg-surface-elevated", children: "Ver agenda" })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 flex flex-wrap gap-2", children: filtros.map((filtro) => {
      const ativo = periodo === filtro.value;
      return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setPeriodo(filtro.value), className: `rounded-full border px-4 py-2 text-sm transition ${ativo ? "border-gold bg-gold-soft text-gold" : "border-border bg-surface text-muted-foreground hover:bg-surface-elevated"}`, children: filtro.label }, filtro.value);
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3", children: cards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-surface p-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 grid gap-4 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-surface p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: "Agendamentos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-4 w-4 text-gold" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-3xl font-display", children: carregando ? "..." : resumo.totalAgendamentos }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "no período selecionado" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-surface p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "atendimentos recebidos" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-surface p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-3xl font-display", children: carregando ? "..." : resumo.previstos }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "solicitados ou confirmados" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border bg-surface p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-muted-foreground", children: "Assinaturas" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "h-4 w-4 text-gold" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-3xl font-display", children: carregando ? "..." : resumo.quantidadeAssinaturas }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "pagamentos de plano" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "overflow-hidden rounded-2xl border border-border bg-surface", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-6 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-medium", children: "Resumo diário do período" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Ideal para fechar o caixa da semana sem olhar o histórico inteiro." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarClock, { className: "h-4 w-4 text-gold" })
        ] }),
        carregando ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-8 text-sm text-muted-foreground", children: "Carregando resumo diário..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-[520px] divide-y divide-border overflow-y-auto", children: resumoPorDia.map((dia) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "grid gap-4 px-6 py-4 md:grid-cols-[1fr_auto_auto_auto]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: dia.label }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Realizado" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: formatarMoeda(dia.receitaRealizada) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Previsto" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: formatarMoeda(dia.receitaPrevista) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Perdido" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: formatarMoeda(dia.receitaPerdida) })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "overflow-hidden rounded-2xl border border-border bg-surface", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-6 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-medium", children: "Formas de pagamento" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Atendimentos pagos e assinaturas recebidas." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-4 w-4 text-gold" })
        ] }),
        carregando ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-8 text-sm text-muted-foreground", children: "Carregando pagamentos..." }) : faturamentoPorPagamento.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-8 text-sm text-muted-foreground", children: "Nenhum pagamento registrado no período." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: faturamentoPorPagamento.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "flex items-center justify-between gap-4 px-6 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-right font-display", children: formatarMoeda(item.valor) })
        ] }, item.formaPagamento)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-8 overflow-hidden rounded-2xl border border-border bg-surface", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-6 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-medium", children: "Últimos recebimentos do período" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Lista curta para conferência rápida do caixa." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "h-4 w-4 text-gold" })
      ] }),
      carregando ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Carregando movimentações..." }) }) : ultimosMovimentos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-64 flex-col items-center justify-center px-6 py-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "h-10 w-10 text-muted-foreground" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 text-lg font-display", children: "Nenhum recebimento no período" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-md text-sm text-muted-foreground", children: "Quando houver atendimento concluído ou assinatura paga, o movimento aparecerá aqui." })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: ultimosMovimentos.map((movimento) => /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "px-6 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: movimento.titulo }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border border-border bg-background px-3 py-1 text-xs text-muted-foreground", children: movimento.tipo === "ASSINATURA" ? "Assinatura" : "Atendimento" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 grid gap-2 text-sm text-muted-foreground md:grid-cols-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: formatarDataHora(movimento.data) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Cliente: ",
              movimento.cliente
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: movimento.detalhe })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left lg:text-right", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-display", children: formatarMoeda(movimento.valorCentavos) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "recebido" })
        ] })
      ] }) }, movimento.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rounded-2xl border border-border bg-surface p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scissors, { className: "h-5 w-5 text-gold" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-medium", children: "Regra atual do financeiro" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Esta tela funciona como caixa do período. Atendimento concluído entra pelo valor recebido. Assinatura entra no dia do pagamento. Solicitações e confirmações entram como previsão. Cancelamentos, recusas e faltas entram como perda estimada. Para análise histórica completa, use a aba Relatórios." })
      ] })
    ] }) })
  ] });
}
