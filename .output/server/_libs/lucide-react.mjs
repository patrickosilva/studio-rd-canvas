...
const Ban = createLucideIcon("ban", __iconNode$L);
const __iconNode$K = [
...
const Cake = createLucideIcon("cake", __iconNode$K);
const __iconNode$J = [
...
const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$G);
const __iconNode$F = [
  ["path", { d: "M8 2v4", key: "1cmpym" }],
  ["path", { d: "M16 2v4", key: "4m81vk" }],
  ["rect", { width: "18", height: "18", x: "3", y: "4", rx: "2", key: "1hopcy" }],
...
const CircleArrowLeft = createLucideIcon("circle-arrow-left", __iconNode$C);
const __iconNode$B = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const UserMinus = createLucideIcon("user-minus", __iconNode$5);
const __iconNode$4 = [
...
export {
  ArrowRight as A,
  TrendingUp as B,
  CircleArrowLeft as C,
  DollarSign as D,
  Funnel as E,
  FileChartColumnIncreasing as F,
  Gift as G,
  History as H,
  Info as I,
  Cake as J,
