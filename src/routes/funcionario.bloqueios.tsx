...
function FuncionarioBloqueiosPage() {
  ...
  async function handleCriarBloqueio(
    ...
    try {
      ...
      setErro(
        "Não foi possível criar o bloqueio. Confira se início, fim e profissional estão corretos.",
      );
    } finally {
      setSalvando(false);
    }
        ...
        <section className="rounded-2xl border border-border bg-surface p-6">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Use para folgas, pausas, feriados, manutenção ou compromissos internos.
              </p>
            </div>
          </div>
          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Bloqueio geral impede qualquer profissional de receber agendamento no período.
              </p>
            </div>
